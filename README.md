...
An example of it in use can be found at my [Space Invaders emulator](https://github.com/amelliyaa/space-invaders).
...
FetchContent_Declare(
        Intel8080
        GIT_REPOSITORY "https://github.com/amelliyaa/intel8080.git"
)
...
### With CMake
```
git clone https://github.com/amelliyaa/intel8080.git
cd Intel8080/
